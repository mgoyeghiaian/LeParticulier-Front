    ...
    <>
      <div className=" flex lg:flex-row gap-5  flex-col p-2 lg:p-5 lg:pr-40 lg:pl-40  h-auto  justify-around items-center ">
        <div className=" flex flex-col md:p-4 justify-centers items-center lg:items-start   flex-wrap w-[97%] lg:w-[50%] gap-5">
          <p className=' lg:text-xl text-3xl' >LE PARTICULER</p>

          <h1 className=' text-2xl lg:text-3xl font-semibold tracking-wider' style={{ 'fontFamily': 'Playfair Display', }} >WELCOME TO THE <span className="lg:block inline lg:pr-4">UNIQUE CITY OASIS</span></h1>
          ...
          <div className='md:text-xl mt-3 text-sm mb-4'>
            <a href="mailto:info@leparticulier.com" className=' border border-black text-black   hover:bg-gray-300 bg-opacity-50 p-2 pr-5 pl-5 rounded text-center hover-bg-opacity-100 transition duration-300 cursor-pointer hover:no-underline hover:text-gray-600'>
