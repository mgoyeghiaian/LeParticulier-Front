  ...
  return (
    <div className="h-auto flex flex-col items-center justify-around p-5 gap-10">
      <div className="flex flex-col justify-center items-center gap-4 text-center">
        ...
        <h1 className="text-xl lg:text-2xl font-semibold tracking-wide" style={{ fontFamily: 'Playfair Display' }}>
      ...
      <div className="w-full overflow-x-auto flex flex-wrap">
        {dummyData.map((item) => (
          <div key={item.id} className="lg:w-1/4 md:w-1/2 w-full p-4">
            <div className="w-full bg-slate-100 border rounded-lg overflow-hidden border-slate-200">
              <img
                src={item.Thumbnail}
                alt={item.Name}
