...
const Gallery = () => {
  return (
    <div className="text-center flex flex-col justify-center items-center lg:gap-4 text-white w-full h-[30vh] lg:h-[70vh] bg-cover bg-center relative" style={{ backgroundImage: `url(${img})` }}>
